...
export const avatarBadges = [
  {
    ...
    role: 'CEO, Hive3',
    image: '/hero-users/stacy-quackenbush.jpeg',
  },
  {
    initials: 'OS',
    name: 'Omar Siddiqui',
    role: 'Founder, Superchamps',
    image: '/hero-users/omar-siddiqui.jpg',
  },
  {
    initials: 'AB',
    name: 'Andrew Baron',
    role: 'Tech Guru, Hive3',
    image: '/hero-users/andrew-baron.jpeg',
  },
  {
    initials: 'MB',
    name: 'Michael Baron',
    role: 'COO, Hive3',
    image: '/hero-users/michael-baron.jpeg',
  },
  {
    initials: 'RB',
    name: 'Rachel Buchanan',
    role: 'Hive3',
    image: '/hero-users/rachel-buchanan.png',
  },
  {
    initials: 'CM',
    name: 'Cherie Mazer',
    role: 'Education, Hive3',
    image: '/hero-users/cherie-mazer.png',
  },
  {
    initials: 'CC',
    name: 'Camilla Caban',
    role: 'Conflux Network',
    image: '/hero-users/camilla-caban.jpg',
  },
  {
    initials: 'ER',
    name: 'Eleonara Rocca',
    role: 'Head of Marketing',
    image: '/hero-users/eleonara-rocca.png',
  },
  {
    initials: 'NP',
    name: 'Norbert Paszkowski',
    role: 'CEO, Arrland',
    image: '/hero-users/norbert-paszkowski.jpg',
  },
  {
    initials: 'BI',
    name: 'Bence Ivancsics',
    role: 'Bellwether',
    image: '/hero-users/bence-ivancsics.jpg',
  },
  {
    initials: 'SG',
    name: 'Shanice Graves',
    role: 'Bellwether',
    image: '/hero-users/shanice-graves.jpg',
  },
  {
    initials: 'RW',
    name: 'Rob Wells',
    role: 'Bellwether',
    image: '/hero-users/rob-wells.jpg',
  },
  {
    initials: 'IK',
    name: 'Iryna Kaplun',
    role: 'Conflux',
    image: '/hero-users/iryna-kaplun.jpg',
  },
  {
    initials: 'SE',
    name: 'Sam E',
    role: 'Conflux',
    image: '/hero-users/sam-e.jpg',
  },
];
